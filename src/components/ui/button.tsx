...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ffdb57] focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer relative overflow-hidden",
  {
    variants: {
      variant: {
        // PRIMARY: Main call-to-action buttons (navy gradient with yellow glow)
        ...
        // SECONDARY: Less prominent actions (transparent with border)
        outline: "bg-transparent text-foreground border-2 border-white/60 hover:border-[#ffdb57] hover:bg-[#0a1840]/10 hover:shadow-[0_0_15px_rgba(255,219,87,0.3)]",

        // GHOST: Minimal styling for portal navigation and subtle actions
        ghost: "hover:bg-accent hover:text-accent-foreground border-2 border-transparent",

        // DESTRUCTIVE: Dangerous actions only (delete, remove, etc.)
        destructive: "bg-gradient-to-br from-red-600 to-red-700 text-white border-2 border-white/80 hover:border-[#ffdb57] hover:shadow-[0_0_20px_rgba(255,219,87,0.4)] shadow-[0_4px_12px_rgba(220,38,38,0.3)]",
      },
      size: {
