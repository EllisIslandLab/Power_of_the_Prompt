  ...
  const { error } = await resend.emails.send({
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h1 style="color: #2563eb;">Your Website Analysis Report is Ready!</h1>
        
        ${name ? `<p>Hi ${name},</p>` : '<p>Hi there,</p>'}
        
        <p>Thank you for using our website analyzer! We've completed a comprehensive analysis of <strong>${url}</strong> and found several opportunities for improvement.</p>
        
        <p>Your detailed PDF report is attached and includes:</p>
        <ul>
          <li>🚀 Performance analysis and optimization tips</li>
          <li>🔍 SEO audit with actionable recommendations</li>
          <li>🔒 Security assessment and best practices</li>
          <li>📱 Mobile optimization opportunities</li>
          <li>♿ Accessibility improvements</li>
        </ul>
        
        <p>Each recommendation is prioritized by impact and includes specific steps to implement the fixes.</p>
        
        <div style="background: #f8fafc; padding: 20px; border-radius: 8px; margin: 20px 0;">
          <h3 style="color: #1f2937; margin-top: 0;">Need Help Implementing These Changes?</h3>
          <p>Our Web Launch Academy course teaches you exactly how to fix these issues and build high-converting websites that grow your business.</p>
          <p><a href="https://weblaunchacademy.com" style="background: #2563eb; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; display: inline-block;">Learn More About Our Course</a></p>
        </div>
        
        <p>Questions about your report? Simply reply to this email - we'd love to help!</p>
        
        <p>Best regards,<br>
        The Web Launch Academy Team</p>
        
        <hr style="margin: 30px 0; border: none; border-top: 1px solid #e5e7eb;">
        <p style="font-size: 12px; color: #6b7280;">
          This report was automatically generated by our website analysis tool. 
          For the most up-to-date analysis, we recommend running the test again if significant changes are made to your website.
        </p>
      </div>
    `,
    attachments: [
