    ...
    <div className="min-h-screen bg-[#050714] py-8 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-3xl font-bold text-white uppercase tracking-wider">Preferences</h1>
          <button
        ...
        {/* Preferences Form */}
        <div className="glass-panel rounded-xl border-t-8 border-white p-6 space-y-6 relative">
          <div className="container-header">Config.v1</div>
          <div className="mt-6">
          {/* Auto-deploy */}
          <div className="border-b border-white/10 pb-6">
            <div className="flex items-start justify-between">
              ...
              <label className="relative inline-flex items-center cursor-pointer ml-4">
                ...
                />
                <div className="w-11 h-6 bg-white/10 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-[#FFB800]/30 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-white/20 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#FFB800]"></div>
              </label>
            </div>
          </div>
